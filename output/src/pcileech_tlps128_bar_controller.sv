...
module pcileech_tlps128_bar_controller #(
    ...
    parameter BAR_APERTURE_SIZE = 65536,
    parameter BAR_INDEX = 2,
    parameter BAR_TYPE = 1, // 0=32-bit, 1=64-bit
    parameter BAR_PREFETCHABLE = 1'b0,
    
    // MSI-X Configuration
    parameter NUM_MSIX = 32,
    parameter MSIX_TABLE_BIR = 4,
    parameter MSIX_TABLE_OFFSET = 0,
    parameter MSIX_PBA_BIR = 4,
    parameter MSIX_PBA_OFFSET = 2048,
    ...
    parameter READ_LATENCY = 8,
    parameter WRITE_LATENCY = 4,
    parameter BURST_LENGTH = 8,
    parameter INTER_BURST_GAP = 16,
    
    // Performance and Error Handling
    parameter ENABLE_ERROR_INJECTION = 1'b1,
    parameter ENABLE_PERFORMANCE_COUNTERS = 1'b1,
    parameter TIMEOUT_CYCLES = 2048
) (
    // Clock and Reset
    input  logic                clk,
    input  logic                reset_n,
    ...
    always_comb begin
        ...
        if (target_region == REGION_STATUS_REG) begin
            case (region_offset[7:2])
                ...
                6'h07: status_reg_rdata = 32'hDEADBEEF;
                default: begin
                    if (region_offset[31:2] < (STATUS_REG_SIZE/4)) begin
            ...
            if (pcileech_enable && current_state == STATE_PCILEECH_EXEC) begin
                case (pcileech_command[7:0])
                    ...
                    PCILEECH_CMD_PROBE: begin
                        pcileech_data_reg <= 32'hDEADBEEF;
    ...
    always_comb begin
        ...
        if (cfg_ext_read_received) begin
            ...
            case (cfg_ext_register_number)
                10'h000: cfg_ext_read_data = 32'h1FBD0000;
                10'h001: cfg_ext_read_data = 32'h00100000;
                10'h002: cfg_ext_read_data = 32'h004E2004;
...
`ifdef XILINX_SIMULATOR
    ...
    initial begin
        ...
        device_ctrl_mem[1] = 32'hDEADBEEF;
        device_ctrl_mem[2] = 32'h00010000;
    end
