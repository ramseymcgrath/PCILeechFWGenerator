...
HD_PWD='/home/muttti/123/output/vivado_project/pcileech_firmware.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log pcileech_tlps128_bar_controller.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source pcileech_tlps128_bar_controller.tcl
