...
class SystemVerilogValidator:
    ...
    def __init__(self):
        ...
        self.problematic_patterns = [
            (r'\binput\s+\w+\s+\w+.*?;', 'Standalone input declaration found outside module ports'),
            (r'\boutput\s+\w+\s+\w+.*?;', 'Standalone output declaration found outside module ports'),
            (r'\binout\s+\w+\s+\w+.*?;', 'Standalone inout declaration found outside module ports'),
        ]
    ...
    def _check_module_structure(self, filepath: Path, content: str) -> bool:
        ...
        include_patterns = [
            'register_declarations', 'error_outputs', 'device_specific_ports',
            'clock_domain_logic', 'interrupt_logic', 'read_logic', 'write_logic',
            'error_declarations', 'error_detection', 'error_handling', 'error_logging',
            'error_state_machine', 'error_injection', 'error_counters', 'error_handling_complete',
            'power_integration', 'power_management', 'power_declarations',
            'performance_counters', 'register_logic'
        ]
    ...
    def _check_standalone_ports(self, filepath: Path, content: str) -> bool:
        ...
        clean_body = re.sub(r'\bfunction\s+.*?\bendfunction\b', '', clean_body, flags=re.DOTALL)
