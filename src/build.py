...
def main():
    ...
    parser = argparse.ArgumentParser(description="FPGA firmware builder - Modular Architecture")
    parser.add_argument("--bdf", required=True, help="Bus:Device.Function (e.g., 0000:03:00.0)")
    parser.add_argument("--board", required=True, help="Target board")
    parser.add_argument("--advanced-sv", action="store_true", help="Enable advanced SystemVerilog")
    parser.add_argument("--enable-behavior-profiling", action="store_true", help="Enable behavior profiling")
    parser.add_argument("--verbose", action="store_true", help="Verbose output")
    parser.add_argument("--use-donor-dump", action="store_true", help="Use donor dump kernel module")
    parser.add_argument("--skip-board-check", action="store_true", help="Skip board validation")
    ...
    try:
        ...
        if 'performance_improvement' in summary:
            improvement = summary['performance_improvement']['estimated_improvement_percent']
