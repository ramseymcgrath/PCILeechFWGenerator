...
class TCLBuilder:
    ...
    def prepare_base_context(
        ...
        context = {
            ...
            "vendor_id": vendor_id or 0x1234,
            "device_id": device_id or 0x5678,
            "revision_id": revision_id or 0x01,
            "class_code": 0x040300,  # Default multimedia audio controller class
