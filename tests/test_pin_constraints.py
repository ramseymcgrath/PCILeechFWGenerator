...
class TestPinConstraints:
    ...
    def test_pin_assignment_patterns(self):
        ...
        pin_assignments = [line for line in result.split('\n') if 'set_property PACKAGE_PIN' in line]
    ...
    def test_iostandard_patterns(self):
        ...
        iostd_assignments = [line for line in result.split('\n') if 'set_property IOSTANDARD' in line]
    ...
    def test_comprehensive_port_coverage(self):
        ...
        expected_ports = [
            'clk', 'reset_n',
            'pcie_rx_data', 'pcie_rx_valid', 'pcie_tx_data', 'pcie_tx_valid',
            'cfg_ext_read_received', 'cfg_ext_write_received',
            'cfg_ext_register_number', 'cfg_ext_function_number',
            'cfg_ext_write_data', 'cfg_ext_write_byte_enable',
            'cfg_ext_read_data', 'cfg_ext_read_data_valid',
            'msix_interrupt', 'msix_vector', 'msix_interrupt_ack',
            'debug_status', 'device_ready'
        ]
