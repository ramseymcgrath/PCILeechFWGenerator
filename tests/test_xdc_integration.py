...
class TestXDCIntegration:
    ...
    def test_get_board_xdc_files_success(self, mock_get_board_path, mock_ensure_git_repo):
    ...
    @patch('src.repo_manager.RepoManager.ensure_git_repo')
    @patch('src.repo_manager.RepoManager.get_board_path')
    def test_get_board_xdc_files_not_found(self, mock_get_board_path, mock_ensure_git_repo):
    ...
    def test_read_xdc_constraints_success(self, mock_get_xdc_files):
        ...
        # Mock file content
        xdc_content1 = "# Board constraints\nset_property PACKAGE_PIN E3 [get_ports clk]"
...
"""
    ...
    def test_board_xdc_content_in_template_context(self):
        ...
        with patch('src.repo_manager.RepoManager.read_xdc_constraints') as mock_read_xdc:
            ...
            try:
                from src.repo_manager import RepoManager
                board_xdc_content = RepoManager.read_xdc_constraints("pcileech_75t484_x1")
