...
class TestVFIOBindingEdgeCases:
    ...
    def test_bind_to_vfio_already_bound(self, mock_exists, mock_run, mock_get_driver):
        ...
        unbind_call = call("echo 0000:03:00.0 > /sys/bus/pci/devices/0000:03:00.0/driver/unbind")
    ...
    @patch("generate.run_command")
    @patch("os.path.exists")
    def test_bind_to_vfio_bind_error_but_already_bound(self, mock_exists, mock_run, mock_get_driver):
