...
def test_bar_controller():
    ...
    template_path = Path("../src/templates/systemverilog/bar_controller.sv.j2")
...
def test_cfg_shadow():
    ...
    template_path = Path("../src/templates/systemverilog/cfg_shadow.sv.j2")
...
def test_msix_table():
    ...
    template_path = Path("../src/templates/systemverilog/msix_table.sv.j2")
...
def test_option_rom_bar():
    ...
    template_path = Path("../src/templates/systemverilog/option_rom_bar_window.sv.j2")
...
def test_option_rom_spi():
    ...
    template_path = Path("../src/templates/systemverilog/option_rom_spi_flash.sv.j2")
