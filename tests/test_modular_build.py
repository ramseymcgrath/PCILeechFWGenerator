...
@pytest.mark.skipif(not MODULAR_BUILD_AVAILABLE, reason="Modular build system not available")
...
if __name__ == "__main__":
    ...
    if MODULAR_BUILD_AVAILABLE:
        ...
        async def test_async():
            ...
            validator = ConfigValidator()
            result = await validator.validate_build_config_async({"bdf": "0000:03:00.0", "board": "75t"})
